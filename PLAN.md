...
- [ ] **9.10.7** Diagnostic parity with Zig checker *(JSON-to-AST bridge: json.kl, ast_builder.kl, checker_parity.kl; Phase 4 parity tests in run-selfhost-tests.sh; Tier 1: 31/31 match-accept, 0 too-strict, 0 too-permissive, 0 known-gap, 0 crash; String type support added; args interleaving bug fixed in ast_builder)*
