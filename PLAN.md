...
- [ ] **9.10.7** Diagnostic parity with Zig checker *(JSON-to-AST bridge: json.kl, ast_builder.kl, checker_parity.kl; Phase 4 parity tests in run-selfhost-tests.sh; Tier 1: 25/31 match-accept, 0 too-strict, 0 too-permissive, 4 known-gap [String type], intermittent native codegen crashes)*
